...
def write_mosart_in(iens):
    ...
    nl_string += '  frivinp_rtm = "/p/scratch/cjicg41/eloundou1/CLM5_DATA/inputdata/"\n'
...
def write_datm_in(syear, eyear, iens, 
                  domname="domain.lnd.SE-Svb_SE-Svb.240511.nc"):
    nl_string = ''
    nl_string += '&datm_nml\n'
    nl_string += '  decomp = "1d"\n'
    ...
    nl_string += ('  domainfile = "/p/scratch/cjicg41/eloundou1/CLM5_DATA/inputdata/share/domains/SE-Svb/' + domname + '"\n')
    ...
    nl_string += ('  streams = "user_datm.streams.clm1PT.SE-Svb.solar.stream_' + str(iens).zfill(4) + '.txt 2009 2009 2018",\n' +
                     '"user_datm.streams.clm1PT.SE-Svb.precip.stream_' + str(iens).zfill(4) + '.txt 2009 2009 2018",\n' +                                    
                     '"user_datm.streams.clm1PT.SE-Svb.other.stream_' + str(iens).zfill(4) + '.txt 2009 2009 2018",\n')
...
def write_drv_flds_in():
    ...
    nl_string += ("  megan_factors_file = '/p/scratch/cjicg41/eloundou1/CLM5_DATA/inputdata/atm/cam/" +
                  "chem/trop_mozart/emis/megan21_emis_factors_78pft_c20161108.nc'\n")
...
def write_drv_in(rundir, syear, eyear, prefix=None):
    nl_string = ""
    ...
    if prefix is None:
        ...
        nl_string += '  case_name = "' + str(prefix) + '"\n'
    ...
    nl_string += '  restart_n = 400\n'
    nl_string += '  restart_option = "nyears"\n'
    nl_string += '  restart_ymd = -999\n'
    nl_string += '  rof_cpl_dt = 10800\n'
    nl_string += '  start_tod = 0\n'
    nl_string += '  start_ymd = '+str(syear)+'0101\n'
    nl_string += '  stop_n = -999\n'
    nl_string += '  stop_option = "never"\n'
    nl_string += '  stop_ymd = '+str(eyear+400)+'1231\n'
...
def write_lnd_in(syear, eyear, iens, prefix="clmoas"):
    ...
    nl_string += " fatmlndfrc = '/p/scratch/cjicg41/eloundou1/CLM5_DATA/inputdata/share/domains/SE-Svb/domain.lnd.SE-Svb_SE-Svb.240511.nc'\n"
    nl_string += " finidat = '/p/scratch/cjicg41/eloundou1/CLM5_DATA/inputdata/restart/SE-Svb/SE-Svb.clm2.r.3901-01-01-00000.nc'\n"
    nl_string += " fsnowaging = '/p/scratch/cjicg41/eloundou1/CLM5_DATA/inputdata/lnd/clm2/snicardata/snicar_drdt_bst_fit_60_c070416.nc'\n"
    nl_string += " fsnowoptics = '/p/scratch/cjicg41/eloundou1/CLM5_DATA/inputdata/lnd/clm2/snicardata/snicar_optics_5bnd_c090915.nc'\n"
    nl_string += " fsurdat = '/p/scratch/cjicg41/eloundou1/CLM5_DATA/inputdata/lnd/clm2/surfdata_map/trial_22/SE-Svb/ensemble/surfdata_SE-Svb_hist_78pfts_CMIP6_simyr2000_c240511_pft_modified.nc_"+ str(iens+1).zfill(5) + ".nc'\n"
    ...
    nl_string += " paramfile = '/p/scratch/cjicg41/eloundou1/CLM5_DATA/inputdata/lnd/clm2/paramdata/ensemble/trial_22/SE-Svb/clm5_params.c171117.nc_"+ str(iens+1).zfill(5) + ".nc'\n"
    ...
    nl_string += " use_init_interp = .true.\n"
    nl_string += " use_lai_streams = .false.\n"
    nl_string += " use_lch4 = .false.\n"
    ...
    nl_string += " stream_fldfilename_ndep = '/p/scratch/cjicg41/eloundou1/CLM5_DATA/inputdata/lnd/clm2/ndepdata/fndep_clm_hist_b.e21.BWHIST.f09_g17.CMIP6-historical-WACCM.ensmean_1849-2015_monthly_0.9x1.25_c180926.nc'\n"
    ...
    nl_string += " stream_fldfilename_popdens = '/p/scratch/cjicg41/eloundou1/CLM5_DATA/inputdata/lnd/clm2/firedata/clmforc.Li_2017_HYDEv3.2_CMIP6_hdm_0.5x0.5_AVHRR_simyr1850-2016_c180202.nc'\n"
    nl_string += " stream_year_first_popdens = 2000\n"
    nl_string += " stream_year_last_popdens = 2000\n"
    nl_string += "/\n"
    nl_string += "&urbantv_streams\n"
    nl_string += " stream_fldfilename_urbantv = '/p/scratch/cjicg41/eloundou1/CLM5_DATA/inputdata/lnd/clm2/urbandata/CLM50_tbuildmax_Oleson_2016_0.9x1.25_simyr1849-2106_c160923.nc'\n"
    ...
    nl_string += " stream_fldfilename_lightng = '/p/scratch/cjicg41/eloundou1/CLM5_DATA/inputdata/atm/datm7/NASA_LIS/clmforc.Li_2012_climo1995-2011.T62.lnfm_Total_c140423.nc'\n"
...
#    nl_string += " do_harvest = .true.\n"
#    nl_string += " do_transient_crops = .true.\n"
#    nl_string += " do_transient_pfts = .true.\n"
#    nl_string += " flanduse_timeseries = '/p/scratch/cjicg41/jicg4177/cesm/inputdata/lnd/clm2/surfdata_map/release-clm5.0.18/landuse.timeseries_1x1_wuestebach_east_hist_78pfts_CMIP6_simyr2000-2100_c191014.nc'\n"
    nl_string += "/\n"
    ...
    nl_string += "/\n"
    with nc.Dataset('/p/scratch/cjicg41/eloundou1/CLM5_DATA/inputdata/lnd/clm2/paramdata/ensemble/trial_22/SE-Svb/clm5_params.c171117.nc_' + str(iens+1).zfill(5) + '.nc', 'r') as f:
        # Read the value of jmaxb1
        jmaxb1_value = f.variables['jmaxb1'][:]
    nl_string += "&luna\n"
    nl_string += " jmaxb1 = " + str(jmaxb1_value) + "\n"
    ...
    nl_string += " stream_fldfilename_ch4finundated = '/p/scratch/cjicg41/eloundou1/CLM5_DATA/inputdata/lnd/clm2/paramdata/finundated_inversiondata_0.9x1.25_c170706.nc'\n"
    nl_string += "/\n"
...
#    nl_string += "!#     /p/project/cslts/slts32/clm5.0/bld/CLM build-namelist -cimeroot /p/project/cslts/slts32/clm5.0/cime/scripts/Tools/../.. -infile /p/scratch/cjicg41/jicg4177/wuestebach/1x1_wuestebach_east_spunup/Buildconf/clmconf/namelist -csmdata /p/scratch/cjicg41/jicg4177/cesm/inputdata -inputdata /p/scratch/cjicg41/jicg4177/wuestebach/1x1_wuestebach_east_spunup/Buildconf/clm.input_data_list -ignore_ic_year -namelist &clm_inparm  start_ymd=20090101 /  -use_case 2000_control -res 1x1_wuestebach_east -clm_usr_name 1x1_wuestebach_east -clm_start_type default -envxml_dir /p/scratch/cjicg41/jicg4177/wuestebach/1x1_wuestebach_east_spunup -l_ncpl 48 -lnd_frac /p/scratch/cjicg41/jicg4177/cesm/inputdata/share/domains/domain.lnd.1x1_wuestebach_east_1x1_wuestebach_east.190725.nc -glc_nec 10 -co2_ppmv 367.0 -co2_type constant -config /p/scratch/cjicg41/jicg4177/wuestebach/1x1_wuestebach_east_spunup/Buildconf/clmconf/config_cache.xml -sim_year=2000-2100 -bgc bgc -crop -clm_accelerated_spinup off -lnd_tuning_mode clm5_0_CRUv7\n"
#    nl_string += "!# For help on options use: /p/project/cslts/slts32/clm5.0/bld/CLM build-namelist -help\n"
    nl_string += ""
...
def write_stream_files(iens, stream):
    ...
    nl_string += '  </variableNames>\n'
    nl_string += '  <filePath>\n'
    nl_string += '     /p/scratch/cjicg41/eloundou1/CLM5_DATA/inputdata/share/domains/SE-Svb\n'
    nl_string += '  </filePath>\n'
    nl_string += '  <fileNames>\n'
    nl_string += '     domain.lnd.SE-Svb_SE-Svb.240511.nc\n'
    nl_string += '  </fileNames>\n'
    nl_string += '</domainInfo>\n'
    nl_string += '<fieldInfo>\n'
    nl_string += '   <variableNames>\n'
...
#        nl_string += '       FLDS lwdn\n'
    ...
    nl_string += '   </variableNames>\n'
    nl_string += '   <filePath>\n'
    nl_string += '     /p/scratch/cjicg41/eloundou1/CLM5_DATA/inputdata/atm/datm7/trial_22/SE-Svb/Ensemble/real_' + str(iens+1).zfill(5) + '\n'
    nl_string += '   </filePath>\n'
    nl_string += '   <fileNames>\n'
    nl_string += '    2009-01.nc\n'
    nl_string += '2009-02.nc\n'
    nl_string += '2009-03.nc\n'
    nl_string += '2009-04.nc\n'
    nl_string += '2009-05.nc\n'
    nl_string += '2009-06.nc\n'
    nl_string += '2009-07.nc\n'
    nl_string += '2009-08.nc\n'
    nl_string += '2009-09.nc\n'
    nl_string += '2009-10.nc\n'
    nl_string += '2009-11.nc\n'
    nl_string += '2009-12.nc\n'
    nl_string += '2010-01.nc\n'
    nl_string += '2010-02.nc\n'
    nl_string += '2010-03.nc\n'
    nl_string += '2010-04.nc\n'
    nl_string += '2010-05.nc\n'
    nl_string += '2010-06.nc\n'
    nl_string += '2010-07.nc\n'
    nl_string += '2010-08.nc\n'
    nl_string += '2010-09.nc\n'
    nl_string += '2010-10.nc\n'
    nl_string += '2010-11.nc\n'
    nl_string += '2010-12.nc\n'
    nl_string += '2011-01.nc\n'
    nl_string += '2011-02.nc\n'
    nl_string += '2011-03.nc\n'
    nl_string += '2011-04.nc\n'
    nl_string += '2011-05.nc\n'
    nl_string += '2011-06.nc\n'
    nl_string += '2011-07.nc\n'
    nl_string += '2011-08.nc\n'
    nl_string += '2011-09.nc\n'
    nl_string += '2011-10.nc\n'
    nl_string += '2011-11.nc\n'
    nl_string += '2011-12.nc\n'
    nl_string += '2012-01.nc\n'
    nl_string += '2012-02.nc\n'
    nl_string += '2012-03.nc\n'
    nl_string += '2012-04.nc\n'
    nl_string += '2012-05.nc\n'
    nl_string += '2012-06.nc\n'
    nl_string += '2012-07.nc\n'
    nl_string += '2012-08.nc\n'
    nl_string += '2012-09.nc\n'
    nl_string += '2012-10.nc\n'
    nl_string += '2012-11.nc\n'
    nl_string += '2012-12.nc\n'
    nl_string += '2013-01.nc\n'
    nl_string += '2013-02.nc\n'
    nl_string += '2013-03.nc\n'
    nl_string += '2013-04.nc\n'
    nl_string += '2013-05.nc\n'
    nl_string += '2013-06.nc\n'
    nl_string += '2013-07.nc\n'
    nl_string += '2013-08.nc\n'
    nl_string += '2013-09.nc\n'
    nl_string += '2013-10.nc\n'
    nl_string += '2013-11.nc\n'
    nl_string += '2013-12.nc\n'
    nl_string += '2014-01.nc\n'
    nl_string += '2014-02.nc\n'
    nl_string += '2014-03.nc\n'
    nl_string += '2014-04.nc\n'
    nl_string += '2014-05.nc\n'
    nl_string += '2014-06.nc\n'
    nl_string += '2014-07.nc\n'
    nl_string += '2014-08.nc\n'
    nl_string += '2014-09.nc\n'
    nl_string += '2014-10.nc\n'
    nl_string += '2014-11.nc\n'
    nl_string += '2014-12.nc\n'
    nl_string += '2015-01.nc\n'
    nl_string += '2015-02.nc\n'
    nl_string += '2015-03.nc\n'
    nl_string += '2015-04.nc\n'
    nl_string += '2015-05.nc\n'
    nl_string += '2015-06.nc\n'
    nl_string += '2015-07.nc\n'
    nl_string += '2015-08.nc\n'
    nl_string += '2015-09.nc\n'
    nl_string += '2015-10.nc\n'
    nl_string += '2015-11.nc\n'
    nl_string += '2015-12.nc\n'
    nl_string += '2016-01.nc\n'
    nl_string += '2016-02.nc\n'
    nl_string += '2016-03.nc\n'
    nl_string += '2016-04.nc\n'
    nl_string += '2016-05.nc\n'
    nl_string += '2016-06.nc\n'
    nl_string += '2016-07.nc\n'
    nl_string += '2016-08.nc\n'
    nl_string += '2016-09.nc\n'
    nl_string += '2016-10.nc\n'
    nl_string += '2016-11.nc\n'
    nl_string += '2016-12.nc\n'
    nl_string += '2017-01.nc\n'
    nl_string += '2017-02.nc\n'
    nl_string += '2017-03.nc\n'
    nl_string += '2017-04.nc\n'
    nl_string += '2017-05.nc\n'
    nl_string += '2017-06.nc\n'
    nl_string += '2017-07.nc\n'
    nl_string += '2017-08.nc\n'
    nl_string += '2017-09.nc\n'
    nl_string += '2017-10.nc\n'
    nl_string += '2017-11.nc\n'
    nl_string += '2017-12.nc\n'
    nl_string += '2018-01.nc\n'
    nl_string += '2018-02.nc\n'
    nl_string += '2018-03.nc\n'
    nl_string += '2018-04.nc\n'
    nl_string += '2018-05.nc\n'
    nl_string += '2018-06.nc\n'
    nl_string += '2018-07.nc\n'
    nl_string += '2018-08.nc\n'
    nl_string += '2018-09.nc\n'
    nl_string += '2018-10.nc\n'
    nl_string += '2018-11.nc\n'
    nl_string += '2018-12.nc\n'
    nl_string += '   </fileNames>\n'
    nl_string += '   <offset>\n'
    nl_string += '     0 \n'
    nl_string += '   </offset>\n'
    ...
    with open("user_datm.streams.clm1PT.SE-Svb."+stream+".stream_" +
...
if __name__ == "__main__":
    ...
    num_ensemble = 128
    b_dir = "/p/project1/cjicg41/eloundou1/tsmp/clm5_0_JURECA_4.4.0MCTPDAF_clm/build"
    r_dir = "/p/scratch/cjicg41/eloundou1/CLM5_DATA/CaseOutputs/Ensemble/trial_22/combined_restart/SE-Svb"

    write_drv_in(r_dir, year_start, year_end, prefix)
    write_drv_flds_in()
